        ...
        <div class="form-card">
            ...
            <form method="post" action="<%= ctx %>/event-booking" novalidate>
                <div class="form-grid">
                    ...
                    <div class="form-group full"><label for="eventNotes">Initial requirements</label><textarea class="form-control" id="eventNotes" name="notes" maxlength="1500" placeholder="Menu preferences, decor style, stage, audio-visual needs, dietary requirements, or other notes"><%= request.getAttribute("formNotes") == null ? "" : com.dinevista.util.HtmlUtil.escape(request.getAttribute("formNotes").toString()) %></textarea></div>
                </div>
