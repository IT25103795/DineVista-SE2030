    ...
    <div class="container">
        <div class="auth-shell">
            ...
            <div class="auth-content">
                ...
                <% if (request.getAttribute("loginError") != null) { %><div class="alert alert-danger"><%= request.getAttribute("loginError") %></div><% } %>
                <form method="post" action="<%= ctx %>/login">
                    ...
                    <div class="form-grid">
                        <div class="form-group full"><label for="loginEmail">Email address</label><input class="form-control" id="loginEmail" name="email" type="email" required autocomplete="email" value="<%= request.getAttribute("formEmail") == null ? "" : request.getAttribute("formEmail") %>" placeholder="name@example.com"></div>
